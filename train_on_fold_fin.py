...
def main():
    ...
    parser.add_argument("--denoise_n_epochs", type=int, default=50)
    parser.add_argument("--acc_n_epochs", type=int, default=50)
    ...
    name = f"{args.config_name}_fold{args.fold}"
    ...
    experiments.train_denoise_model(
        config_name="denoise",
        n_epochs=args.denoise_n_epochs,
        save_name=f"denoise_{name}",
